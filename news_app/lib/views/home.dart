      ...
      child: Container(
        ...
        child:Stack(children: [
          ...
          Container(
            ...
            child:Text(categoryName,style:TextStyle(color: Colors.white,fontSize:14,fontWeight: FontWeight.w700))
          )
        ],)
      ),
    );
...
class BlogTile extends StatelessWidget {
  ...
  BlogTile({required this.imageUrl,required this.title,required this.desc,required this.articleUrl});
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap:(){
        Navigator.push(context,MaterialPageRoute(builder: (context)=>
        ArticleView(imageUrl: articleUrl)
        ));
      },
      child: Container(
        ...
        child:Column(
          children: [
            ClipRRect(child: Image.network(imageUrl),borderRadius: BorderRadius.circular(7),),
            Padding(
